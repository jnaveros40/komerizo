...
export default function CoordinadorComisionEmpresarialDashboardPage() {
  const { user } = useAuth()
  ...
  if (loading) {
    return <div className="coordinador-comision-empresarial-loading"><p>Cargando dashboard...</p></div>
  }

  return (
    <div className="coordinador-comision-empresarial-container">
      <div className="coordinador-comision-empresarial-header">
        <h1>💼 Dashboard Comisión Empresarial</h1>
      ...
      <div className="dashboard-content">
        <p>Aquí irá el contenido del dashboard de Comisión Empresarial...</p>
      </div>
    </div>
  )
}
