...
export default function ComisionConvivenciaDashboardPage() {
  const { user } = useAuth()
  ...
  if (loading) {
    return <div className="comision-convivencia-loading"><p>Cargando dashboard...</p></div>
  }

  return (
    <div className="comision-convivencia-container">
      <div className="comision-convivencia-header">
        <h1>🤝 Dashboard Convivencia y Conciliación</h1>
      ...
      <div className="dashboard-content">
        <p>Aquí irá el contenido del dashboard de Convivencia y Conciliación...</p>
      </div>
    </div>
  )
}
