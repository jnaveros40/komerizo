...
export default function VicepresidenteDashboardPage() {
  const { user } = useAuth()
  ...
  if (loading) {
    return <div className="vicepresidente-loading"><p>Cargando dashboard...</p></div>
  }

  return (
    <div className="vicepresidente-container">
      <div className="vicepresidente-header">
        <h1>🩵 Dashboard Vicepresidente</h1>
      ...
      <div className="dashboard-content">
        <p>Aquí irá el contenido del dashboard del Vicepresidente...</p>
      </div>
    </div>
  )
}
