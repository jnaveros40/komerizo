...
export default function VocalDashboardPage() {
  const { user } = useAuth()
  ...
  if (loading) {
    return <div className="vocal-loading"><p>Cargando dashboard...</p></div>
  }

  return (
    <div className="vocal-container">
      <div className="vocal-header">
        <h1>🎤 Dashboard Vocal</h1>
      ...
      <div className="dashboard-content">
        <p>Aquí irá el contenido del dashboard del Vocal...</p>
      </div>
    </div>
  )
}
