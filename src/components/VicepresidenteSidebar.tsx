...
import './VicepresidenteSidebar.css'

export default function VicepresidenteSidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    ...
    {
      label: 'Solicitudes',
      href: '/vicepresidente/solicitudes',
      icon: '📋',
    },
    {
      label: 'Reuniones',
      href: '/vicepresidente/reuniones',
      icon: '📅',
    },
    {
      label: 'Miembros',
  ...
  return (
    <aside className="vicepresidente-sidebar">
      ...
      <div className="sidebar-footer">
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Vicepresidente (Admin)</p>
          </div>
        </div>
        <button
