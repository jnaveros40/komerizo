...
export default function UsuarioSidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    ...
    { href: '/usuario/tesoreria', label: 'Tesorería', icon: '💰' },
    { href: '/usuario/asistencia', label: 'Asistencia', icon: '📅' },
    { href: '/usuario/solicitudes-tramites', label: 'Solicitudes y Trámites', icon: '📝' },
    { href: '/usuario/tienda', label: 'Tienda', icon: '🛍️' },
