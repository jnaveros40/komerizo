...
import './ComisionConvivenciaSidebar.css'

export default function ComisionConvivenciaSidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    ...
    {
      label: 'Miembros',
      href: '/comision-convivencia/miembros',
      icon: '👥',
    },
    {
      label: 'Actividades',
      href: '/comision-convivencia/actividades',
      icon: '🎯',
    },
  ]
  ...
  return (
    <aside className="comision-convivencia-sidebar">
      ...
      <div className="sidebar-footer">
          ...
          <div className="role-selector">
            ...
            <div className="role-dropdown-container">
              ...
              >
                ...
                <span className="role-name">Convivencia</span>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Comisión (Admin)</p>
          </div>
        </div>
        <button
