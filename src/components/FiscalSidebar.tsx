...
import './FiscalSidebar.css'

export default function FiscalSidebar({ user }: { user: any }) {
      ...
      <div className="sidebar-footer">
          ...
          <div className="role-selector">
            ...
            <div className="role-dropdown-container">
              ...
              >
                ...
                <span className="role-name">Fiscal</span>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Fiscal (Admin)</p>
          </div>
        </div>
        <button
