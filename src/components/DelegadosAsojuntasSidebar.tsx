...
import './DelegadosAsojuntasSidebar.css'

export default function DelegadosAsojuntasSidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    {
      label: 'Dashboard',
      href: '/delegados-asojuntas',
      icon: '📊',
    },
    {
      label: 'Solicitudes',
      href: '/delegados-asojuntas/solicitudes',
      icon: '📋',
    },
    {
      label: 'Reuniones',
    ...
    {
      label: 'Miembros',
      href: '/delegados-asojuntas/miembros',
      icon: '👥',
    },
  ]
  ...
  return (
    <aside className="delegados-asojuntas-sidebar">
      ...
      <div className="sidebar-footer">
          ...
          <div className="role-selector">
            ...
            <div className="role-dropdown-container">
              ...
              >
                ...
                <span className="role-name">Delegado</span>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Delegado (Admin)</p>
          </div>
        </div>
        <button
