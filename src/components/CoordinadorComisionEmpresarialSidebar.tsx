...
import './CoordinadorComisionEmpresarialSidebar.css'

export default function CoordinadorComisionEmpresarialSidebar({ user }: { user: any }) {
  ...
  const menuItems = [
    {
      label: 'Dashboard',
      href: '/coordinador-comision-empresarial',
      icon: '📊',
    },
    {
      label: 'Solicitudes',
    ...
    {
      label: 'Reuniones',
      href: '/coordinador-comision-empresarial/reuniones',
      icon: '📅',
    },
    {
    ...
    {
      label: 'Reportes',
      href: '/coordinador-comision-empresarial/reportes',
      icon: '📈',
    },
    {
      label: 'Miembros',
      href: '/coordinador-comision-empresarial/miembros',
      icon: '👥',
    },
  ]
  ...
  const isActive = (href: string) => {
    if (href === '/coordinador-comision-empresarial') {
  ...
  return (
    <aside className="coordinador-comision-empresarial-sidebar">
      ...
      <div className="sidebar-footer">
          ...
          <div className="role-selector">
            ...
            <div className="role-dropdown-container">
              ...
              >
                ...
                <span className="role-name">Coordinador</span>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Coordinador (Admin)</p>
          </div>
        </div>
        <button
