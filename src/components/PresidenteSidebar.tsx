...
import './PresidenteSidebar.css'

export default function PresidenteSidebar({ user }: { user: any }) {
      ...
      <div className="sidebar-footer">
          ...
          <div className="role-selector">
            ...
            <div className="role-dropdown-container">
              ...
              >
                ...
                <span className="role-name">Presidente</span>
        ...
        <div className="user-info">
          ...
          <div className="user-details">
            ...
            <p className="user-role">Presidente (Admin)</p>
          </div>
        </div>
        <button
